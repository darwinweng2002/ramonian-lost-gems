...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $username = $_POST['email']; // Use email as username for now
    ...
    $stmt->bind_param("ssssssssss", $first_name, $last_name, $college, $course, $year, $section, $username, $password, $school_id_file, $status);
