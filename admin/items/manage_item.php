                    ...
                    <form action="" id="items-form">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="datetime-local" name="time_found" id="time_found" class="form-control form-control-sm rounded-0" value="<?php echo isset($time_found) ? date('Y-m-d\TH:i', strtotime($time_found)) : ''; ?>" required/>
                            </div>
                        </div>
                        <div class="row">
