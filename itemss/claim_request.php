...
// Database connection
$conn = new mysqli('localhost', 'u450897284_root', 'Lfisgemsdb1234', 'u450897284_Ifis_db'); // Replace with your actual DB connection details
...
$userSql = "SELECT course, year, section FROM user_member WHERE id = ?";
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            <form action="process_claim.php" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="course" value="<?php echo htmlspecialchars($userInfo['course']); ?>">
                <input type="hidden" name="year" value="<?php echo htmlspecialchars($userInfo['year']); ?>">
                <input type="hidden" name="section" value="<?php echo htmlspecialchars($userInfo['section']); ?>">
