    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            foreach ($items as $itemId => $itemData) {
                ...
                echo "<p style='color: #555; font-size: 16px; margin-top: 20px;'>If you find this item, please take it to the SSG Office located in the OSA Building and turn it in.</p>";
